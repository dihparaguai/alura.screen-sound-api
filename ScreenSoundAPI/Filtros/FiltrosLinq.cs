...
internal class FiltrosLinq
{
    ...
    {
        var todosGeneros = musicas.Select(musicas => musicas.Genero).Distinct().ToList(); // pega o parametro, e seleciona todos os generos dos objetos, sendo não repetidos, convertidos numa lista
